...
abstract class Theme {
  ...
  private themeEditor() {
    return {
      ...
      "editor.selectionBackground": this.alpha(this.lighten(this.colorTre, 5), 20),
      "editor.inactiveSelectionBackground": this.alpha(this.mix(this.colorBG2, this.darken(this.colorTre, 10), 50), 20),
